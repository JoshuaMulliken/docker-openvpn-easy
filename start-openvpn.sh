...
docker run -d --name openvpn-easy -p 7797:7797 -e USERNAME -e PASSWORD --cap-add=NET_ADMIN --device /dev/net/tun -v $OVPN_PATH:/vpn/vpnconfig.ovpn --sysctl net.ipv6.conf.all.disable_ipv6=0 openvpn-easy:0.0.3
